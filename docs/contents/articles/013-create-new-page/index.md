...
2) Then let's create a blank angular 2 component for our page called 'komunikat.component.ts' inside of `src/app/pages/new`:
...
3) After that we should create our component routing called `komunikat.routing.ts` in the `new` directory.
...
4) And now we should create `komunikat.module.ts` in `src/app/pages/new` directory and import `komunikat.component.ts` and `komunikat.routing.ts` in it.
